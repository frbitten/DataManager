    ...
    public class ValueConverterGroup : IValueConverter
    {
        ...
        object IValueConverter.Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            for (int i = 0; i < this.Converters.Count; ++i)
            {
                ...
                Type currentTargetType = this.GetTargetType(value, i, targetType, true);
        ...
        object IValueConverter.ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            for (int i = this.Converters.Count - 1; i > -1; --i)
            {
                ...
                {
                    IValueConverter converter = this.Converters[i];
                    Type currentTargetType = this.GetTargetType(value, i, targetType, false);
        ...
        protected virtual Type GetTargetType(object value, int converterIndex, Type finalTargetType, bool convert)
        {
            ...
            if (nextConverter != null)
            {
                if (cachedAttributes.ContainsKey(nextConverter) && cachedAttributes[nextConverter] != null)
                {
        ...
        void OnConvertersCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (convertersToProcess != null && convertersToProcess.Count > 0)
            {
                foreach (IValueConverter converter in convertersToProcess)
                {
                    ...
                    {
                        this.cachedAttributes.Add(converter, null);
                    } 
                    else
                    {
